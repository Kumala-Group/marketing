                        ...
                        <div class="card-block">
                            <div class="table-responsive">
                                <div style="height: 50%;width: 100%;overflow-x: auto;overflow-y: auto;white-space: nowrap;">
                                    <table class="table table-sm table-bordered" id="tabel-pengeluaran-unit">
                                    </table>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    var datatables = $('#tabel-pengeluaran-unit').DataTable({
        // scrollY: 450,
        processing: true,
        serverSide: true,
        order: [],
        // responsive: true,
        ajax: {
            url: "<?= base_url(); ?>audit/kumalagroup_bank_pengeluaran/get_pengeluaran_unit",
            type: 'POST',
    ...
    function update_status(value, no_pengeluaran) {
        ...
        $.post("<?= base_url(); ?>audit/kumalagroup_bank_pengeluaran/set_status_cek_pengeluaran_unit_for_audit", {
                'status': status,
