...
<script type="text/javascript">
    ...
    var datatables = $('#tabel-pengeluaran-after-sales').DataTable({
        ...
        // responsive: true,
        ajax: {
            url: "<?= base_url(); ?>audit/kumalagroup_kas_pengeluaran/get_pengeluaran_after_sales",
            type: 'POST',
    ...
    function update_status(value, no_pengeluaran) {
        ...
        $.post("<?= base_url(); ?>audit/kumalagroup_kas_pengeluaran/set_status_cek_pengeluaran_after_sales_for_audit", {
                'status': status,
