                    ...
                    <div class="card-body collapse in">
                        <div class="card-block">
                            ...
                            <div style="height: 50%;width: 100%;overflow-x: auto;overflow-y: auto;white-space: nowrap;">
                                <table class="table table-sm table-bordered" id="tabel-penerimaan-after-sales">
                                </table>
                            </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    var datatables = $('#tabel-penerimaan-after-sales').DataTable({
        // scrollY: 450,
        processing: true,
        serverSide: true,
        order: [],
        // responsive: true,
        ajax: {
            url: "<?= base_url(); ?>audit/kumalagroup_bank_penerimaan/get_penerimaan_after_sales",
            type: 'POST',
            data: function(data) {
    ...
    function update_status(value, no_penerimaan) {
        ...
        $.post("<?= base_url(); ?>audit/kumalagroup_bank_penerimaan/set_status_cek_penerimaan_after_sales_for_audit", {
                'status': status,
