                        ...
                        <div class="card-block">
                            <div class="table-responsive">
                                <div style="height: 50%;width: 100%;overflow-x: auto;overflow-y: auto;white-space: nowrap;">
                                    <table class="table table-sm table-bordered" id="kas-penerimaan-unit">
                                    </table>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    var datatables = $('#kas-penerimaan-unit').DataTable({
        // scrollY: 450,
        processing: true,
        serverSide: true,
        order: [],
        // responsive: true,
        ajax: {
            url: "<?= base_url(); ?>audit/kumalagroup_kas_penerimaan/get_penerimaan_unit",
            type: 'POST',
            data: function(data) {
    ...
    function update_status(value, no_penerimaan) {
        ...
        $.post("<?= base_url(); ?>audit/kumalagroup_kas_penerimaan/set_status_cek_penerimaan_unit_for_audit", {
                'status': status,
