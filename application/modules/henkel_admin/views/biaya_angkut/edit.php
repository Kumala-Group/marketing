...
<table class="table table-striped table-bordered table-hover">
    ...
    <tbody>
        ...
        $i=1;
        $jml = 0;
        $a = remove_separator2($total_transaksi);
        $ppn = ($a*10)/100;
        $total_transaksi_ppn = $a+$ppn;
        ...
        <tr>
          ...
          ?>
            ...
            <td class="center"><?php echo 'Rp. '.separator_harga2($dt->harga_item);?></td>
    ...
    <div class="row-fluid">
         ...
         <div class="span4">
          ...
          <div class="control-group">
              ...
              <div class="controls total_harga">
                <input type="text" name="sub_total" id="sub_total" value="<?php echo separator_harga2($sub_total); ?>" readonly>
              </div>
         </div>
          <div class="control-group">
          ...
          <div class="control-group">
              ...
              <div class="controls total_harga">
                ...
                <input type="text" name="total_akhir" id="total_akhir" class="span12" value="<?php echo separator_harga2($total_transaksi); ?>" placeholder="Total Akhir"  readonly="readonly"/>
              </div>
         </div>
     </div>
...
<div class="row-fluid">
     <div class="span12" align="center">
         ...
         <i class="icon-print"></i> Invoice
          ...
          <a href="<?php echo base_url();?>index.phphenkel_adm_pesanan_pembelian/tambah" class="btn btn-small btn-success"  role="button" data-toggle="modal" name="tambah" id="tambah">
              <i class="icon-plus"></i>
              Transaksi Baru
          </a>
        ...
        <div class="row-fluid">
            ...
            <br>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="kode_item" id="kode_item" placeholder="Kode Item" />
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="control-group">
                    <label class="control-label" for="form-field-1">Harga Satuan</label>

                    <div class="controls">
                        <input type="text" value="0" min="0" name="harga_satuan" id="harga_satuan" placeholder="Harga Satuan" readonly="readonly" />
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" value="0" min="0" name="harga" id="harga" placeholder="Harga"/>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="form-field-1">Diskon</label>
