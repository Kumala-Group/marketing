...
function cari_data(){
  ...
  $.ajax({
    type	: 'POST',
    url		: "<?php echo site_url(); ?>henkel_adm_lap_penjualan_sales/cari_data",
    	...
    	<div class="widget-main">
            ...
            <div class="alert alert-success">
              <center>
                ...
                <button type="button" name="cetak_pdf" id="cetak_pdf" class="btn btn-mini btn-danger" onclick="cetak_data('<?php echo site_url();?>henkel_adm_lap_penjualan_sales/cetak_pdf_penjualan')">
                	 <i class="fa fa-file-pdf-o"></i> Cetak PDF
                </button>
  							<button type="button" name="cetak_excel" id="cetak_excel" class="btn btn-mini btn-success" onclick="cetak_data('<?php echo site_url();?>henkel_adm_lap_penjualan_sales/cetak_excel_penjualan')">
