...
function cari_data(){
  ...
  $.ajax({
    type	: 'POST',
    url		: "<?php echo site_url(); ?>henkel_adm_lap_penjualan_pelanggan/cari_data",
    	...
    	<div class="widget-main">
            ...
            <form class="form-horizontal" name="my-form" id="my-form">
              ...
              <!--<div class="control-group">
                  <label class="control-label" for="form-field-1">No Invoice</label>
                   <div class="controls">
                    <div class="input-append">
                            <input type="text" name="invoice_awal" id="invoice_awal"/>
                        <span class="add-on">
                    ...
                    <b> s/d </b>
                    <div class="input-append">
                            <input type="text" name="invoice_akhir" id="invoice_akhir"/>
                        <span class="add-on">
                            <i class="fa fa-bars" aria-hidden="true"></i>
                        </span>
                    </div>
            ...
            <div class="alert alert-success">
              <center>
                ...
                <button type="button" name="cetak_pdf" id="cetak_pdf" class="btn btn-mini btn-danger" onclick="cetak_data('<?php echo site_url();?>henkel_adm_lap_penjualan_pelanggan/cetak_pdf_penjualan')">
                	 <i class="fa fa-file-pdf-o"></i> Cetak PDF
                </button>
  							<button type="button" name="cetak_excel" id="cetak_excel" class="btn btn-mini btn-success" onclick="cetak_data('<?php echo site_url();?>henkel_adm_lap_penjualan_pelanggan/cetak_excel_penjualan')">
