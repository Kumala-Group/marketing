    	...
    	<div class="widget-main">
            ...
            <div class="alert alert-success">
              <center>
                ...
                <button type="button" name="cetak_pdf" id="cetak_pdf" class="btn btn-mini btn-danger" onclick="cetak_data('<?php echo site_url();?>henkel_adm_lap_pembelian_detail/cetak_pdf_pembelian')">
