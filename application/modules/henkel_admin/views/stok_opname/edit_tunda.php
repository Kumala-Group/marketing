...
function autoseparator(Num) { //function to add commas to textboxes
    ...
    function editData(ID){
    	...
    	$.ajax({
    		type	: "GET",
    		url		: "<?php echo site_url(); ?>henkel_adm_stok_opname/t_cari_inserted",
    		data	: "cari="+cari,
    		dataType: "json",
    		success	: function(data){
          ...
          <div class="control-group">
              ...
              <div class="controls">
                <div class="input-append">
                  <input type="text" name="tanggal_awal" id="tanggal_awal" value="<?php echo $tanggal_awal?>" readonly/>
                </div>
              </div>
            </div>
            <div class="control-group">
                ...
                <div class="controls">
                  <div class="input-append">
                    <input type="text" name="tanggal_akhir" id="tanggal_akhir" value="<?php echo $tanggal_akhir?>" readonly/>
                  </div>
                </div>
              </div>
            <div class="control-group">
              ...
              <div class="controls">
                <input type="hidden" name="kode_gudang" id="kode_gudang" value="<?php echo $kode_gudang?>" readonly/>
                <input type="text" name="nama_gudang" id="nama_gudang" value="<?php echo $nama_gudang?>" readonly/>
              </div>
            </div>
            <div class="space"></div>
         </div>
        ...
        <tr>
            ...
            <td class="td-actions"><center>
                <div class="text-phone visible-desktop action-buttons">
                  <?php if ($dt->status > 0)  { ?>
                    <a class="green" href="#modal-table" onclick="javascript:editDataInserted('<?php echo $dt->id_t_stok_opname;?>')" data-toggle="modal">
                    <span class="green">
