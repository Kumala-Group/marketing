              ...
              success : function(data){
                ...
                $("#simpan_pesanan_pengiriman").click(function(){
                  ...
                  if(tanggal_pengiriman.length==0){
                    ...
                    $.ajax({
                        type    : 'POST',
                        url     : "<?php echo site_url(); ?>henkel_adm_pesanan_pengiriman/simpan",
                        data    : string,
                        cache   : false,
                        success : function(data){
                          alert(data);
...
function hapusData(id){
  ...
  if (r == true) {
    $.ajax({
  		...
  		type	: "POST",
  		url		: "<?php echo site_url(); ?>henkel_adm_pengiriman/hapus/"+id,
  		data	: "id_h="+id,
  		dataType: "json",
  		success	: function(){
        location.reload();
...
<div class="row-fluid">
     <div class="span12" align="center">
          <a href="<?php echo base_url();?>index.phphenkel_adm_pesanan_pengiriman/tambah" class="btn btn-small btn-success"  role="button" data-toggle="modal" name="tambah" id="tambah">
              <i class="icon-plus"></i>
              Transaksi Baru
          </a>
