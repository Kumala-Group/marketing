...
<table class="table fpTable lcnp table-striped table-bordered table-hover">
    ...
    <tbody>
        ...
        <tr>
            ...
            <?php 
              $q = $this->db_kpp->query("SELECT id_pesanan_pembelian FROM pesanan_pembelian WHERE no_po='$dt->no_po'")->row(); 
              $id_pesanan_pembelian = $q->id_pesanan_pembelian;
            ?>
            <td class="center"><a href="<?php echo site_url();?>henkel_adm_pesanan_pembelian/edit/<?php echo $id_pesanan_pembelian; ?>"><?php echo $dt->no_po;?></a></td>
            <td class="center"><?php echo $dt->no_invoice;?></td>
            <td class="center"><?php echo tgl_sql($dt->tanggal_invoice);?></td>
            <td class="center"><?php echo separator_harga2($dt->total_akhir);?></td>
            <td class="td-actions"><center>
                <div class="hidden-phone visible-desktop action-buttons">
                  <a class="green" href="<?php echo site_url();?>henkel_adm_invoice_supplier/edit/<?php echo $dt->id_item_masuk;?>">
