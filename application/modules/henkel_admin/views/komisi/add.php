...
$(document).ready(function(){
        ...
        $("#simpan").click(function(){
            ...
            $.ajax({
                type    : 'POST',
                url     : "<?php echo site_url(); ?>henkel_adm_komisi/t_simpan",
                data    : string,
                cache   : false,
        ...
        $("#simpan_komisi").click(function(){
            ...
            $.ajax({
                type    : 'POST',
                url     : "<?php echo site_url(); ?>henkel_adm_komisi/cek_table",
                data    : "id_cek="+id,
                success : function(data){
                  if(data==0){
                    $.gritter.add({
                    ...
                    $.ajax({
                        type    : 'POST',
                        url     : "<?php echo site_url(); ?>henkel_adm_komisi/simpan",
                        data    : string,
                        cache   : false,
                        ...
                        success : function(data){
                          ...
                          var id= $("#id").val();
                          alert(data);
                          location.replace("<?php echo site_url(); ?>henkel_adm_komisi/edit/"+id)
                        }
                    });
                  }
                }
        ...
        $(window).on('beforeunload', function(){
          localStorage.setItem('nama_skema', $('#nama_skema').val());
        });
});
  ...
  $.ajax({
      ...
      success : function(data){
        if(data==0){
          ...
          var nama_skema = localStorage.getItem('nama_skema');
          $('#nama_skema').val(nama_skema);
        }
    }
    });
}
...
function editData(ID){
  ...
  $.ajax({
    type  : "GET",
    url   : "<?php echo site_url(); ?>henkel_adm_komisi/t_cari",
    data  : "cari="+cari,
    dataType: "json",
    success : function(data){
      $('#id_t_komisi').val(data.id_t_komisi);
...
function hapusData(id){
  ...
  $.ajax({
    		type	: "POST",
    		url		: "<?php echo site_url(); ?>henkel_adm_komisi/t_hapus/"+id,
    		data	: "id_h="+id,
    		dataType: "json",
    		success	: function(){
          location.reload();
        ...
        <tr>
            ...
            <td class="td-actions"><center>
                <div class="hidden-phone visible-desktop action-buttons">
                    <a class="green" href="#modal-table" onclick="javascript:editData('<?php echo $dt->id_t_komisi;?>')" data-toggle="modal">
                        <i class="icon-pencil bigger-130"></i>
                    </a>

                    <a class="red" href="#" onclick="javascript:hapusData('<?php echo $dt->id_t_komisi;?>')">
...
<div id="modal-table" class="modal hide fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
    ...
    <div class="modal-body no-padding">
        <div class="row-fluid">
            ...
            <input type="hidden" name="id_t_komisi" id="id_t_komisi">
            <br>
                <div class="control-group">
