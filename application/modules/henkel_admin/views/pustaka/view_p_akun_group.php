...
$(document).ready(function(){
	...
	$("#simpan").click(function(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/henkel_adm_p_akun_group/simpan",
			data	: string,
			cache	: false,
...
function editData(ID){
	...
	$.ajax({
		type	: "GET",
		url		: "<?php echo site_url(); ?>/henkel_adm_p_akun_group/cari",
		data	: "cari="+cari,
		dataType: "json",
		success	: function(data){
			//alert(data.ref);
        ...
        <tr>
            ...
            <td class="td-actions"><center>
            	<div class="hidden-phone visible-desktop action-buttons">
                    ...
                    <a class="red" href="<?php echo site_url();?>/henkel_adm_p_akun_group/hapus/<?php echo $dt->id_akun_group;?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
