...
$(document).ready(function(){
        ...
        $("#simpan").click(function(){
            ...
            $.ajax({
                type    : 'POST',
                url     : "<?php echo site_url(); ?>henkel_adm_program_penjualan/t_simpan",
                data    : string,
                cache   : false,
        ...
        $("#simpan_program_penjualan").click(function(){
            ...
            $.ajax({
                type    : 'POST',
                url     : "<?php echo site_url(); ?>henkel_adm_program_penjualan/cek_table",
                data    : "id_cek="+id,
                success : function(data){
                  if(data==0){
                    $.gritter.add({
                    ...
                    $.ajax({
                        ...
                        success : function(data){
                          ...
                          var id= $("#id").val();
                          alert(data);
                          location.replace("<?php echo site_url(); ?>henkel_adm_program_penjualan/edit/"+id)
                        }
                    });
                  }
                }
        ...
        $(window).on('beforeunload', function(){
          localStorage.setItem('nama_program', $('#nama_program').val());
        });
});
  ...
  $.ajax({
      ...
      success : function(data){
        if(data==0){
          ...
          var nama_program = localStorage.getItem('nama_program');
...
function editData(ID){
  ...
  $.ajax({
    type  : "GET",
    url   : "<?php echo site_url(); ?>henkel_adm_program_penjualan/t_cari",
    data  : "cari="+cari,
    dataType: "json",
    success : function(data){
      $('#id_t_program_penjualan').val(data.id_t_program_penjualan);
...
function hapusData(id){
  ...
  $.ajax({
    		type	: "POST",
    		url		: "<?php echo site_url(); ?>henkel_adm_program_penjualan/t_hapus/"+id,
    		data	: "id_h="+id,
    		dataType: "json",
    		success	: function(){
          location.reload();
        ...
        <tr>
            ...
            <td class="td-actions"><center>
                <div class="hidden-phone visible-desktop action-buttons">
                    <a class="green" href="#modal-table" onclick="javascript:editData('<?php echo $dt->id_t_program_penjualan;?>')" data-toggle="modal">
                        <i class="icon-pencil bigger-130"></i>
                    </a>

                    <a class="red" href="#" onclick="javascript:hapusData('<?php echo $dt->id_t_program_penjualan;?>')">
...
<div id="modal-table" class="modal hide fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
    ...
    <div class="modal-body no-padding">
        <div class="row-fluid">
            ...
            <input type="hidden" name="id_t_program_penjualan" id="id_t_program_penjualan">
            <br>
                <div class="control-group">
