    ...
    <div class="modal-body no-padding">
        <div class="row-fluid">
            ...
            <div class="control-group">
                <label class="control-label" for="form-field-1">Potongan Hutang</label>
                <input type="hidden" name="potongan_hutang" id="potongan_hutang" value="potongan hutang"/>
                <div class="controls">
                  <?php ?>
            ...
            <div class="control-group">
                <label class="control-label" for="form-field-1">Potongan Piutang</label>
                <div class="controls">
                  <?php ?>
                  <select name="kode_akun" id="kode_akun">
                    <option value="" selected="selected">--Pilih Nama Akun--</option>
                ...
                <div class="control-group">
                    <label class="control-label" for="form-field-1">Laba Selisih Kurs</label>
                    <div class="controls">
                      <?php ?>
                      <select name="kode_akun" id="kode_akun">
                        <option value="" selected="selected">--Pilih Nama Akun--</option>
                    ...
                    <div class="control-group">
                        <label class="control-label" for="form-field-1">Rugi Setelah Kurs</label>
                        <div class="controls">
                          <?php ?>
                          <select name="kode_akun" id="kode_akun">
                            <option value="" selected="selected">--Pilih Nama Akun--</option>
