...
<div id="modal-table" >
    ...
    <div class="modal-body no-padding">
        <div class="row-fluid">
            ...
            <div class="control-group">
                <label class="control-label" for="form-field-1">Potongan Penjualan</label>
                <div class="controls">
                  <?php ?>
            ...
            <div class="control-group">
                <label class="control-label" for="form-field-1">Pajak Penjualan</label>
                <div class="controls">
                  <?php ?>
                  <select name="kode_akun" id="kode_akun">
                    <option value="" selected="selected">--Pilih Nama Akun--</option>
                ...
                <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="form-field-1">Pembyaran Debit</label>
                            <div class="controls">
                              <?php ?>
                              <select name="kode_akun" id="kode_akun">
                                <option value="" selected="selected">--Pilih Nama Akun--</option>
                            ...
                            <div class="control-group">
                                <label class="control-label" for="form-field-1">Pembyaran Kartu Kredit</label>
                                <div class="controls">
                                  <?php ?>
                                  <select name="kode_akun" id="kode_akun">
                                    <option value="" selected="selected">--Pilih Nama Akun--</option>
                                ...
                                <div class="control-group">
                                    <label class="control-label" for="form-field-1">Pembyaran Kredit</label>
                                    <div class="controls">
                                      <?php ?>
                                      <select name="kode_akun" id="kode_akun">
                                        <option value="" selected="selected">--Pilih Nama Akun--</option>
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="form-field-1">Komisi Sales</label>
                                        <div class="controls">
                                          <?php ?>
                                          <select name="kode_akun" id="kode_akun">
                                            <option value="" selected="selected">--Pilih Nama Akun--</option>
    ...
    <div class="modal-body no-padding">
        <div class="row-fluid">
            ...
            <div class="control-group">
                ...
                <div class="control-group">
                    <label class="control-label" for="form-field-1">Pembayaran Tunai</label>
                    <div class="controls">
                      <?php ?>
                      <select name="kode_akun" id="kode_akun">
                        <option value="" selected="selected">--Pilih Nama Akun--</option>
                ...
                <div class="control-group">
                    <label class="control-label" for="form-field-1">Pembayaran Debit</label>
                    <div class="controls">
                      <?php ?>
                      <select name="kode_akun" id="kode_akun">
                        <option value="" selected="selected">--Pilih Nama Akun--</option>
                ...
                <div class="control-group">
                    <label class="control-label" for="form-field-1">Pembayaran Kartu Kredit</label>
                    <div class="controls">
                      <?php ?>
                      <select name="kode_akun" id="kode_akun">
                        <option value="" selected="selected">--Pilih Nama Akun--</option>
    ...
    <div class="modal-header no-padding">
        <div class="table-header">
            Data Akun Pesanan Penjualan / SO
        </div>
    </div>
