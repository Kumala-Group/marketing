...
<div class="table-header">
    ...
    <div class="widget-toolbar no-border pull-right">
      ...
      <input type="hidden" value="<?php echo $id_hutang;?>" name="id_pes" id="id_pes">
    </div>
</div>
...
<table class="table fpTable lcnp table-striped table-bordered table-hover">
    <thead>
        <tr>
            ...
            <th class="center">Total Hutang</th>
    ...
    <tbody>
        ...
        foreach($data->result() as $dt){
          $q= $this->db_kpp->query("SELECT SUM(bayar) as total_bayar FROM hutang WHERE id_pembayaran_hutang='$dt->id_pembayaran_hutang'");
       ...
       ?>
        <tr>
            ...
            <td class="center"><?php echo $dt->no_hutang;?></td>
            ...
            <td class="td-actions"><center>
                <div class="hidden-phone visible-desktop action-buttons">
                    <a class="green" href="<?php echo site_url();?>henkel_adm_pembayaran_hutang/edit/<?php echo $dt->id_pembayaran_hutang;?>">
                        <i class="icon-eye-open"></i>
                    </a>

                    <!--<a class="red" href="<?php echo site_url();?>henkel_adm_pembayaran_hutang/hapus/<?php echo $dt->id_pembayaran_hutang;?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
