        ...
        <tr>
            ...
            <td class="td-actions"><center>
                <div class="hidden-phone visible-desktop action-buttons">
                    <a class="green" href="#modal-table" onclsick="javascript:editData('<?php echo $dt->id_pembelian;?>')" data-toggle="modal">
                        <i class="icon-pencil bigger-130"></i>
                    </a>

                    <a class="red" href="<?php echo site_url();?>/henkel_adm_pembelian/hapus/<?php echo $dt->id_pembelian;?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
            ...
            <br>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <?php
                            $data = $this->model_pembelian->data_supplier();
                            foreach($data->result() as $dt){
                        ?>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <?php
                            $data = $this->model_pembelian->data_item();
                            foreach($data->result() as $dt){
                        ?>
