...
<div class="table-header">
 ...
 <div class="widget-toolbar no-border pull-right">
   <a href="<?php echo site_url(); ?>henkel_adm_hitungan_komisi/tambah" class="btn btn-small btn-success"  role="button" data-toggle="modal" name="tambah" id="tambah">
...
<table class="table fpTable lcnp table-striped table-bordered table-hover">
    <thead>
        <tr>
            ...
            <th class="center">Nama Komisi</th>
        ...
        <tr>
            ...
            <td class="td-actions"><center>
                <div class="hidden-phone visible-desktop action-buttons">
                  <a class="red" href="<?php echo site_url();?>henkel_adm_hitungan_komisi/edit/<?php echo $dt->id_komisi;?>">
