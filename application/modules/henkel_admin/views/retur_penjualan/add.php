      ...
      if(this.checked) {
        ...
        $("#show").click(function(){
            ...
            $.ajax({
              ...
              error : function(data){
                alert('Data Transaksi Kosong / Pelanggan Tidak Memiliki NPWP');
                var id= $("#id").val();
                $.ajax({
                    type    : 'POST',
        ...
        $("#cek").click(function(){
          ...
          var id_retur_penjualan= $("#id").val();
          var kode_pelanggan= $("#kode_pelanggan").val();
          $.ajax({
              type    : 'POST',
              url     : "<?php echo site_url(); ?>henkel_adm_retur_penjualan/cek",
              data    : {no_penjualan:no_penjualan,id_retur_penjualan:id_retur_penjualan,kode_pelanggan:kode_pelanggan},
              success : function(data){
                if(data==0){
                  alert('Transaksi dengan Kode '+no_penjualan+' kosong');
                  location.reload();
                }else {
        ...
        */
        ...
        $("#simpan").click(function(){
          ...
          if(harga_satuan.length==0){
            ...
            $.ajax({
                type    : 'POST',
                url     : "<?php echo site_url(); ?>henkel_adm_r_penjualan/t_simpan",
                data    : string,
                cache   : false,
                success : function(data){
                    location.reload();
        ...
        $("#simpan_retur_penjualan").click(function(){
            ...
            if (r == true) {
              $.ajax({
                  type    : 'POST',
                  url     : "<?php echo site_url(); ?>henkel_adm_retur_penjualan/t_simpan",
                  data    : string,
                  cache   : false,
                  success : function(data){
                    var id= $("#id").val();
                    alert(data);
                    location.replace("<?php echo site_url(); ?>henkel_adm_retur_penjualan/edit/"+id)
                  }
              });
            }else {
              return false();
...
window.onload = function() {
  ...
  $.ajax({
      type    : 'POST',
      url     : "<?php echo site_url(); ?>henkel_adm_retur_penjualan/cek_table",
      data    : "id_cek="+id,
      success : function(data){
        if(data==0){
          $("#kode_pelanggan").val('');
          ...
          var no_penjualan = localStorage.getItem('no_penjualan');
...
function editData(ID){
  ...
  $.ajax({
    type  : "GET",
    url   : "<?php echo site_url(); ?>henkel_adm_r_penjualan/t_cari",
    data  : "cari="+cari,
    dataType: "json",
    success : function(data){
   ...
   <div class="row-fluid">
        <div class="span6">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" class="autocomplete" value="<?php echo $alamat;?>" name="alamat" id="alamat" placeholder="Alamat"/>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="form-field-1">No. Transaksi</label>
                    <div class="controls">
                        <input type="text" class="autocomplete" value="" name="no_penjualan" id="no_penjualan" placeholder="No. Transaksi"/>
                        <button type="button" id="show" name="show" class="btn btn-info btn-small" data-toggle="modal">
          ...
          ?>
            ...
            <td class="td-actions"><center>
                <div class="text-phone visible-desktop action-buttons">
                    <a class="green" href="#modal-table" onclick="javascript:editData('<?php echo $dt->id_t_r_penjualan;?>')" data-toggle="modal">
     ...
     <div class="span4">
      ...
      <div class="span4">
        <div class="control-group" id="form_enable">
            ...
            <div class="controls total_harga">
                <input type="text" class="span12 number" style="text-align: right;" value="" name="tunai" id="tunai" placeholder="0" readonly="readonly"/>
            </div>
       </div>
       <div id="form_deposit" class="control-group">
           ...
           <div class="controls">
               <input class="span12 number" type="text" style="text-align: right;" value=""  name="deposit" id="deposit" placeholder="0" readonly="readonly"/>
           </div>
       </div>
       <div id="form_pp" class="control-group">
           ...
           <div class="controls total_harga">
             <input type="text" class="span12 number" style="text-align: right;" name="potong_piutang" id="potong_piutang" placeholder="0" readonly="readonly"/>
           </div>
      </div>
      ...
      <div class="span4">
            ...
            <div class="control-group">
             ...
             <div class="hidden">
                  <input type="text" class="span12 number" style="text-align: right;" value="<?php echo separator_harga2($total_transaksi); ?>" min='0' name="total_akhir" id="total_akhir" placeholder="0" readonly="readonly" />
             </div>
              <div class="control-group">
        ...
        <div class="row-fluid">
            ...
            <div class="control-group">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" value="0" class="number" min="0" name="harga" id="harga" placeholder="Harga" readonly="readonly"/> <span style="font-weight:bold">Rp</span>
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" value="0" class="number" min="0" name="total" id="total" placeholder="Total" readonly="readonly" /> <span style="font-weight:bold">Rp</span>
                    </div>
                </div>
