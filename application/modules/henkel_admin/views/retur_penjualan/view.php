        ...
        <tr>
            ...
            <td class="td-actions"><center>
                <div class="hidden-phone visible-desktop action-buttons">
                    <a class="green" href="<?php echo site_url();?>henkel_adm_retur_penjualan/edit/<?php echo $dt->id_retur_penjualan;?>">
                    ...
                    <a class="red" href="<?php echo site_url();?>henkel_adm_retur_penjualan/hapus/<?php echo $dt->id_retur_penjualan;?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
