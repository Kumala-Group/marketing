<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#simpan").click(function() {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo site_url(); ?>hd_adm_update_hrd/simpan",
                data: string,
                cache: false,
        ...
        $("#simpan_detail").click(function() {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo site_url(); ?>hd_adm_update_hrd/simpan_detail_update",
                data: string,
                cache: false,
    ...
    function hapus_data(ID, ID_VERSI, NO_URUT) {
        ...
        if (validasi_hapus == true) {
            $.ajax({
                type: "POST",
                url: "<?php echo site_url(); ?>hd_adm_update_hrd/hapus_data",
                data: {
                    id: id,
                    id_versi: id_versi,
                    no_urut: no_urut
                ...
                success: function(data) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo site_url(); ?>hd_adm_update_hrd/delete_update",
                        data: {
                            id: id,
                            id_versi: id_versi,
                            no_urut: no_urut
    ...
    function edit_data(id, id_versi) {
        ...
        $.ajax({
            type: "get",
            url: "<?php echo site_url(); ?>hd_adm_update_hrd/cari_data",
            data: {
                id: id,
                id_versi: id_versi
            },
