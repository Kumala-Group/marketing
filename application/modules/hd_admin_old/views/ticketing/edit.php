...
$(document).ready(function(){
        ...
        $("#cari_no_po").click(function(){
          ...
          $.ajax({
            type	: "GET",
            url		: "<?php echo site_url();?>oli_adm_datatable/no_po_angkut",
            //data	: "no_po="+no_po,
            dataType: "json",
            success	: function(data){
                      ...
                      "bProcessing": true,
                      "bDestroy": true,
                      "sAjaxSource": '<?php echo site_url();?>oli_adm_datatable/no_po_angkut',
                      "bSort": false,
                      "bAutoWidth": true,
        ...
        $("#new").click(function(){
          ...
          $.ajax({
              ...
              data    : "id_new="+id,
              success : function(data){
                location.replace("<?php echo site_url(); ?>oli_adm_pesanan_pengiriman/tambah");
              }
          });
        });
                ...
                $("#simpan").click(function(){
                    ...
                    $.ajax({
                        type    : 'POST',
                        url     : "<?php echo site_url(); ?>oli_adm_pengiriman/simpan",
                        data    : string,
                        cache   : false,
                ...
                $("#simpan_pesanan_pengiriman").click(function(){
                  ...
                  if(tanggal_pengiriman.length==0){
                    ...
                    $.ajax({
                        type    : 'POST',
                        url     : "<?php echo site_url(); ?>oli_adm_pesanan_pengiriman/simpan",
                        data    : string,
                        cache   : false,
                        success : function(data){
                          alert(data);
                          location.replace("<?php echo site_url(); ?>oli_adm_pesanan_pengiriman");
                        }
                    });
                });
...
function editData(ID){
  ...
  $.ajax({
    type  : "GET",
    url   : "<?php echo site_url(); ?>oli_adm_pengiriman/cari",
    data  : "cari="+cari,
    dataType: "json",
    success : function(data){
...
function hapusData(id){
  ...
  if (r == true) {
    $.ajax({
  		...
  		type	: "POST",
  		url		: "<?php echo site_url(); ?>oli_adm_pengiriman/hapus/"+id,
  		data	: "id_h="+id,
  		dataType: "json",
  		success	: function(){
        location.reload();
...
<form class="form-horizontal" name="form_pengiriman" id="form_pengiriman">
<div class="row-fluid">
<div class="table-header">
    <?php echo 'No. Invoice Pengiriman : ';?><input type="text" name="no_inv_pengiriman" id="no_inv_pengiriman" placeholder="No. Invoice Pengiriman" value="<?php echo $no_inv_pengiriman?>">
          ...
          <div class="control-group">
              ...
              <div class="controls">
                <div class="input-append">
                  <input type="text" name="tanggal_pengiriman" id="tanggal_pengiriman" class="date-picker"  data-date-format="dd-mm-yyyy" placeholder="Tanggal Pengiriman" value="<?php echo $tanggal_pengiriman?>"/>
                </div>
              </div>
          </div>
          <div class="control-group">
              ...
              <div class="controls">
                  <input type="text" name="biaya_pengiriman" id="biaya_pengiriman" onkeyup="javascript:this.value=autoseparator(this.value);" placeholder="Biaya Pengiriman" onkeyup="javascript:this.value=autoseparator(this.value);" onkeydown="return justAngka(event)" value="<?php echo $biaya_pengiriman?>"/>
          </div>
       </div>
         </div>
         <div class="span6">
        ...
        <tr>
            ...
            <td class="td-actions"><center>
                <div class="hidden-phone visible-desktop action-buttons">
                    <a class="green" href="#modal-table" onclick="javascript:editData('<?php echo $dt->id_pengiriman;?>')" data-toggle="modal">
                        <i class="icon-pencil bigger-130"></i>
                    </a>

                    <a class="red" href="#" onclick="javascript:hapusData('<?php echo $dt->id_pengiriman;?>')">
...
<div class="row-fluid">
     <div class="span12" align="center">
          <a href="<?php echo base_url();?>index.phpoli_adm_pesanan_pengiriman/tambah" class="btn btn-small btn-success"  role="button" data-toggle="modal" name="tambah" id="tambah">
              <i class="icon-plus"></i>
              Transaksi Baru
          </a>
