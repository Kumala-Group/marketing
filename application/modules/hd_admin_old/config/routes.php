...
$route['biodata/simpan'] = "hd_admin/biodata/simpan"; // untuk simpan data
$route['biodata_karyawan'] = "hd_admin/biodata_karyawan";

$route['test'] = "hd_admin/test";
$route['test/tambah_aksi'] = "hd_admin/test/tambah_aksi";
$route['test/hapus/(:num)'] = "hd_admin/test/hapus";
$route['test/edit/(:num)'] = "hd_admin/test/edit";
