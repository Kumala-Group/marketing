        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title" id="title_profil">Tambah Jenis Event</h5>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group mb-1">
                                            <input type="text" id="event_jenis" name="event_jenis" class="form-control" placeholder="Jenis Event" required>
                                        </div>
...
<script>
        ...
        columns: [{
            ...
            render: function(r) {
                return `<div class="form-group mb-0">
                    ...
                    <button type="button" onclick="edit_data(` + r.id_event_jenis + `);" class="btn btn-info"><i class="icon-ios-compose-outline"></i></button>
                    <button type="button" onclick="hapus_data(` + r.id_event_jenis + `,'` + r.event_jenis + `');" class="btn btn-danger"><i class="icon-ios-trash-outline"></i></button>
                    </div></div>`;
            },
        }],
    });
    $("#event_jenis").keyup(function() {
    ...
    function edit_data(id) {
        $('#form').trigger('reset');
        $('#title_profil').html("Edit Jenis Event");
        $('#id').val(id);
        $('#submit').removeAttr('disabled');
