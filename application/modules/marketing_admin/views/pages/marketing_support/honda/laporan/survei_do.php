			...
			<div class="card">
				...
				<div class="card-body collapse in">
					<div class="card-block font-small-2">
						<div class="row">
							<form id="form" class="form" action="<?= base_url("marketing_support/honda_laporan_survei_do/export") ?>" method="post">
								<div class="col-md-3">
...
<script>
	$(document).ready(function() {
		...
		$.ajax({
			type: "POST",
			url: "<?= site_url('marketing_support/honda_laporan_survei_do/select2_cabang'); ?>",
			dataType: "JSON",
			success: function(resultData) {
				...
				$.ajax({
					type: "POST",
					url: "<?= site_url('marketing_support/honda_laporan_survei_do/select2_tahun'); ?>",
					dataType: "JSON",
					success: function(data) {
						...
						$.ajax({
							type: "POST",
							url: "<?= site_url('marketing_support/honda_laporan_survei_do/select2_bulan'); ?>",
							dataType: "JSON",
							success: function(data) {
								$("#opt-bulan").select2({
									data: data,
								...
								table_survei = $("#table_survei").DataTable({
									...
									ajax: {
										type: "POST",
										url: "<?= site_url('marketing_support/honda_laporan_survei_do/get') ?>",
										data: function(data) {
