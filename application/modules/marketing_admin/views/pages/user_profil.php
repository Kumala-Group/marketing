                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group mb-1">
                                            <input type="text" id="nama_level" name="nama_level" class="form-control" placeholder="Nama Profil" required>
                                        </div>
                                        <div class="form-group mb-1">
                                            <input type="text" id="level" name="level" class="form-control" placeholder="Kode Profil" required>
                                        </div>
                                        <div class="form-group mb-1">
                                            <textarea id="deskripsi" name="deskripsi" rows="2" class="form-control" placeholder="Deskripsi"></textarea>
                                        </div>
                                        <div class="form-group mb-1">
                                            <textarea id="url" name="url" rows="2" class="form-control" placeholder="Akses URL" required></textarea>
                                        </div>
                                                            ...
                                                            <td>
                                                                <div class="form-group mb-0">
                                                                    <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                                                                        ...
                                                                        <button type="button" onclick="hapus_data(<?= $r->id ?>,'<?= $r->nama_level ?>');" class="btn btn-danger"><i class="icon-ios-trash-outline"></i></button>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
        ...
        swal({
            ...
            if (ok) {
                $.post(location, {
                    ...
                    if (r == 1) swal("", "Profil berhasil dihapus!", "success").then(function() {
                        location.reload();
                    });
                    else swal("", "Profil sedang digunakan!", "error");
                });
            }
        });
    }
