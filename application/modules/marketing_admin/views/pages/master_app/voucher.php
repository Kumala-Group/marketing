        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title" id="title_profil">Tambah Voucher</h5>
                            ...
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <div class="form-group mb-1">
                                            <input type="text" id="tanggal" name="tanggal" class="form-control" placeholder="Tanggal Berlaku" autocomplete="off" required>
                                        </div>
                                                ...
                                                <tbody>
                                                    <?php foreach ($data as $r) : ?>
                                                        <tr>
                                                            <td><?= $r->judul ?></td>
                                                            <td><?= $r->deskripsi ?></td>
                                                            <td><?= tgl_sql($r->tanggal_berlaku) ?></td>
                                                            <td>
...
<script>
    ...
    function edit_data(id) {
        $('#form').trigger('reset');
        $('#title_profil').html("Edit Voucher");
        $('#id').val(id);
        $('#submit').removeAttr('disabled');
