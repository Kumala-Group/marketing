<style>
    ...
    .nav-tabs .nav-link-home:focus,
    .nav-tabs .nav-link-home:hover {
        color: #FFF !important;
    ...
    .nav-tabs .nav-item.show .nav-link-home,
    .nav-tabs .nav-link-home.active {
        color: #FFF !important;
        box-shadow: 0px 3px 8px #aaa, inset 0px 2px 3px #fff;
        background-color: #f7f7f7;
        background-image: -webkit-gradient(linear, left top, left bottom, from(#f71714), to(#941111));
...
<div class="row">
    <div class="col-lg-12 col-md-12 p-0 mt-md-0 mt-0">
        <ul class="nav nav-tabs">
            <li class="nav-item"><a class="nav-link nav-link-home" data-toggle="tab" href="#"><i class="fa fa-line-chart"></i> Sales Report</a></li>
            <li class="nav-item"><a class="nav-link nav-link-home" onclick="loadPageInner('g_honda_after_sales');" data-toggle="tab" href="#"><i class="fa fa-gears"></i> After Sales Report</a></li>
            <li class="nav-item"><a class="nav-link nav-link-home" data-toggle="tab" href="#"><i class="fa fa-bar-chart"></i> Marketing Report</a></li>
            <li class="nav-item"><a class="nav-link nav-link-home active show" onclick="loadPageInner('g_honda_financial_report');" data-toggle="tab" href="#"><i class="fa fa-money"></i> Financial Report</a></li>
            <li class="nav-item"><a class="nav-link nav-link-home" data-toggle="tab" href="#"><i class="fa fa-list-ul"></i> Login History</a></li>
        </ul>
    </div>
</div>
...
<script>
    $('document').ready(function() {
        loadPageInner('g_honda_financial_report');
    });
</script>