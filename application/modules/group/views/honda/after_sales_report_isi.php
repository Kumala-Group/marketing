<div style="overflow-x:auto;">
    <table class="table table-bordered table-hover font-small-3">
        ...
        <tbody class="font-small-3">
            ...
            <tr>
                <td class="center">Total Penerimaan Part Counter</td>
                <?php for ($i = 1; $i <= 12; $i++) : ?>
                    <th style="text-align:center;"><?= separator_harga($total_part_counter[$i]) ?></th>
                <?php endfor ?>
                <th style="text-align:center;"><?= separator_harga(array_sum($total_part_counter)) ?></th>
            </tr>
            <tr>
                <td class="center">Total Penerimaan Service</td>
                <?php for ($i = 1; $i <= 12; $i++) : ?>
                    <th style="text-align:center;"><?= separator_harga($total_service[$i]) ?></th>
                <?php endfor ?>
                <th style="text-align:center;"><?= separator_harga(array_sum($total_service)) ?></th>
            </tr>
            <tr>
                <td class="center">Total Penerimaan Belum Teralokasikan</td>
                <?php for ($i = 1; $i <= 12; $i++) : ?>
                    <th style="text-align:center;"><?= separator_harga($total_lainnya[$i]) ?></th>
                <?php endfor ?>
                <th style="text-align:center;"><?= separator_harga(array_sum($total_lainnya)) ?></th>
            </tr>
            <!--<tr>
