...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 p-0 mt-1">   
        ...
        $per_lokasi=array();
        $per_id=array();
        $qp=$this->db->select('id_perusahaan,lokasi')->where("id_brand='17' AND singkat NOT LIKE '%HO%'")->get('perusahaan');
        ...
        <table class="table table-bordered table-hover nowrap" id="table">
                ...
                <tbody>
                    <tr>
                        ...
                        foreach($per_id as $id=> $val_id){
                            $saldo=0;
                            $saldo_awal= $this->db_honda->select('saldo_awal')->where("kode_akun='110103' AND id_perusahaan='$id'")->get('akun_saldo')->row()->saldo_awal;

                            $saldo=$saldo_awal;

                            $qsa = $this->db_honda->query("SELECT jumlah as total,dk FROM buku_besar WHERE tgl <= '$now' AND id_perusahaan='$id'
                    ...
                    <tr>
                        ...
                        foreach($per_id as $id=> $val_id){
                            $saldo=0;
                            $saldo_awal= $this->db_honda->select('saldo_awal')->where("kode_akun='110102' AND id_perusahaan='$id'")->get('akun_saldo')->row()->saldo_awal;
                    ...
                    <tr>
                        ...
                        foreach($per_id as $id=> $val_id){
                            $saldo=0;
                            $saldo_awal= $this->db_honda->select('saldo_awal')->where("kode_akun='110202' AND id_perusahaan='$id'")->get('akun_saldo')->row()->saldo_awal;
                    ...
                    <tr>
                        ...
                        foreach($per_id as $id=> $val_id){
                            $saldo=0;
                            $saldo_awal= $this->db_honda->select('saldo_awal')->where("kode_akun='110201' AND id_perusahaan='$id'")->get('akun_saldo')->row()->saldo_awal;
                    ...
                    <tr>
                        ...
                        foreach($per_id as $id=> $val_id){
                            $saldo=0;
                            $saldo_awal= $this->db_honda->select('saldo_awal')->where("kode_akun='110203' AND id_perusahaan='$id'")->get('akun_saldo')->row()->saldo_awal;
                    ...
                    <tr>
                        ...
                        foreach($per_id as $id=> $val_id){
                            $saldo=0;
                            $saldo_awal= $this->db_honda->select('saldo_awal')->where("kode_akun='110401' AND id_perusahaan='$id'")->get('akun_saldo')->row()->saldo_awal;
                    ...
                    <tr>
                        ...
                        foreach($per_id as $id=> $val_id){
                            $saldo=0;
                            $saldo_awal= $this->db_honda->select('saldo_awal')->where("kode_akun='110403' AND id_perusahaan='$id'")->get('akun_saldo')->row()->saldo_awal;
                    ...
                    <tr>
                        ...
                        $tot_us=0;
                        foreach($per_id as $id=> $val_id){
                            $unit=$this->db_honda->select("COUNT(no_transaksi) as total")->where("id_perusahaan='$id' AND batal='n' AND  EXTRACT( YEAR_MONTH FROM tgl )='$year$month'")->get('penjualan_unit')->row()->total;
                    ...
                    <tr>
                        ...
                        foreach($per_id as $id=> $val_id){
                            $revenue_unit[$id]=0;
                            $unit=0;$diskon=0;
                            $qsa_unit = $this->db_honda->query("SELECT jumlah as total,dk FROM buku_besar WHERE EXTRACT( YEAR_MONTH FROM tgl )='$year$month' AND id_perusahaan='$id'
                            ...
                            $qsa_diskon = $this->db_honda->query("SELECT jumlah as total,dk FROM buku_besar WHERE EXTRACT( YEAR_MONTH FROM tgl )='$year$month' AND id_perusahaan='$id'
                    ...
                    <tr>
                        ...
                        foreach($per_id as $id=> $val_id){
                            ...
                            $qsa_workshop = $this->db_honda->query("SELECT jumlah as total,dk FROM buku_besar WHERE EXTRACT( YEAR_MONTH FROM tgl )='$year$month' AND id_perusahaan='$id'
                    ...
                    <tr>
                        ...
                        foreach($per_id as $id=> $val_id){
                            ...
                            $qsa = $this->db_honda->query("SELECT jumlah as total,dk FROM buku_besar WHERE EXTRACT( YEAR_MONTH FROM tgl )='$year$month' AND id_perusahaan='$id'
                    ...
                    <tr>
                        ...
                        foreach($per_id as $id=> $val_id){
                            ...
                            $opex_plus=0;
                            $opex_minus=0;
                            $q_opex_plus = $this->db_honda->query("SELECT jumlah as total,dk FROM buku_besar WHERE EXTRACT( YEAR_MONTH FROM tgl )='$year$month' AND id_perusahaan='$id'
                            ...
                            $q_opex_minus = $this->db_honda->query("SELECT jumlah as total,dk FROM buku_besar WHERE EXTRACT( YEAR_MONTH FROM tgl )='$year$month' AND id_perusahaan='$id'
                    ...
                    <tr>
                        ...
                        foreach($per_id as $id=> $val_id){
                            ...
                            $q_o_inc = $this->db_honda->query("SELECT jumlah as total,dk FROM buku_besar WHERE EXTRACT( YEAR_MONTH FROM tgl )='$year$month' AND id_perusahaan='$id'
                    ...
                    <tr>
                        ...
                        foreach($per_id as $id=> $val_id){
                            ...
                            $q_o_exp = $this->db_honda->query("SELECT jumlah as total,dk FROM buku_besar WHERE EXTRACT( YEAR_MONTH FROM tgl )='$year$month' AND id_perusahaan='$id'
