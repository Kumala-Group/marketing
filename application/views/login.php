...
<body data-open="click" data-menu="vertical-menu" data-col="1-column" class="vertical-layout vertical-menu 1-column  blank-page blank-page bg">
                        ...
                        <div class="card m-0" style="border-radius: 25px;">
                            ...
                            <div class="card-body collapse in">
                                <div class="card-block">
                                    <form class="form-horizontal form-simple" id="form" method="post" action="<?php echo base_url(); ?>login">
    ...
    <a href="<?php echo site_url(); ?>login_ticketing" class="div-icon">
        <div class="icon-hd">
            <i class="icon-paste icon-large icon-border"></i><div class="hide">&nbspPengaduan Ticket</div>
        </div> 
    </a>
