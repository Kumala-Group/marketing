...
/* Database HelpDesk */
$db['db_helpdesk']['hostname'] = '127.0.0.1';
$db['db_helpdesk']['username'] = 'root';
...
/* Database OLI */
$db['db_oli']['hostname'] = '127.0.0.1';
$db['db_oli']['username'] = 'root';
$db['db_oli']['password'] = '168168168kmg';
$db['db_oli']['database'] = 'db_oli';
$db['db_oli']['dbdriver'] = 'mysqli';
$db['db_oli']['dbprefix'] = '';
$db['db_oli']['pconnect'] = FALSE;
$db['db_oli']['db_debug'] = (ENVIRONMENT !== 'production');
$db['db_oli']['cache_on'] = FALSE;
$db['db_oli']['cachedir'] = '';
$db['db_oli']['char_set'] = 'utf8';
$db['db_oli']['dbcollat'] = 'utf8_general_ci';
$db['db_oli']['swap_pre'] = '';
$db['db_oli']['autoinit'] = TRUE;
$db['db_oli']['stricton'] = FALSE;



/* Database Wuling */
$db['db_wuling']['hostname'] = '127.0.0.1';
$db['db_wuling']['username'] = 'root';
...
/* Database Wuling SP */
$db['db_wuling_sp']['hostname'] = '127.0.0.1';
$db['db_wuling_sp']['username'] = 'root';
...
/* Database Wuling AS*/
$db['db_wuling_as']['hostname'] = '127.0.0.1';
$db['db_wuling_as']['username'] = 'root';
...
/* Database honda */
$db['db_honda']['hostname'] = '127.0.0.1';
$db['db_honda']['username'] = 'root';
...
/* Database honda SP */
$db['db_honda_sp']['hostname'] = '127.0.0.1';
$db['db_honda_sp']['username'] = 'root';
...
/* Database honda AS*/
$db['db_honda_as']['hostname'] = '127.0.0.1';
$db['db_honda_as']['username'] = 'root';
...
/* Database Hino*/
$db['db_hino']['hostname'] = '127.0.0.1';
$db['db_hino']['username'] = 'root';
...
/* Database mercedes*/
$db['db_mercedes']['hostname'] = '127.0.0.1';
$db['db_mercedes']['username'] = 'root';
...
/* Database honda SP */
$db['db_mercedes_sp']['hostname'] = '127.0.0.1';
$db['db_mercedes_sp']['username'] = 'root';
...
$db['db_mercedes_as']['hostname'] = '127.0.0.1';
$db['db_mercedes_as']['username'] = 'root';
...
/* Database KPP*/
$db['db_kpp']['hostname'] = '127.0.0.1';
$db['db_kpp']['username'] = 'root';
...
/* Database KSA*/
$db['db_ksa']['hostname'] = '127.0.0.1';
$db['db_ksa']['username'] = 'root';
...
/* Database KSS*/
$db['db_kss']['hostname'] = '127.0.0.1';
$db['db_kss']['username'] = 'root';
...
/* Database KSA SP*/
$db['db_ksa_sp']['hostname'] = '127.0.0.1';
$db['db_ksa_sp']['username'] = 'root';
...
/* Database KPP SP*/
$db['db_kpp_sp']['hostname'] = '127.0.0.1';
$db['db_kpp_sp']['username'] = 'root';
$db['db_kpp_sp']['password'] = '168168168kmg';
$db['db_kpp_sp']['database'] = 'db_kpp_sp';
$db['db_kpp_sp']['dbdriver'] = 'mysqli';
$db['db_kpp_sp']['dbprefix'] = '';
$db['db_kpp_sp']['pconnect'] = FALSE;
$db['db_kpp_sp']['db_debug'] = (ENVIRONMENT !== 'production');
$db['db_kpp_sp']['cache_on'] = FALSE;
$db['db_kpp_sp']['cachedir'] = '';
$db['db_kpp_sp']['char_set'] = 'utf8';
$db['db_kpp_sp']['dbcollat'] = 'utf8_general_ci';
$db['db_kpp_sp']['swap_pre'] = '';
$db['db_kpp_sp']['autoinit'] = TRUE;
$db['db_kpp_sp']['stricton'] = FALSE;

/* Database HINO AS*/
$db['db_hino_as']['hostname'] = '127.0.0.1';
$db['db_hino_as']['username'] = 'root';
$db['db_hino_as']['password'] = '168168168kmg';
$db['db_hino_as']['database'] = 'db_hino_as';
$db['db_hino_as']['dbdriver'] = 'mysqli';
$db['db_hino_as']['dbprefix'] = '';
$db['db_hino_as']['pconnect'] = FALSE;
$db['db_hino_as']['db_debug'] = (ENVIRONMENT !== 'production');
$db['db_hino_as']['cache_on'] = FALSE;
$db['db_hino_as']['cachedir'] = '';
$db['db_hino_as']['char_set'] = 'utf8';
$db['db_hino_as']['dbcollat'] = 'utf8_general_ci';
$db['db_hino_as']['swap_pre'] = '';
$db['db_hino_as']['autoinit'] = TRUE;
$db['db_hino_as']['stricton'] = FALSE;

/* Database HINO SP*/
$db['db_hino_sp']['hostname'] = '127.0.0.1';
$db['db_hino_sp']['username'] = 'root';
$db['db_hino_sp']['password'] = '168168168kmg';
$db['db_hino_sp']['database'] = 'db_hino_sp';
$db['db_hino_sp']['dbdriver'] = 'mysqli';
$db['db_hino_sp']['dbprefix'] = '';
$db['db_hino_sp']['pconnect'] = FALSE;
$db['db_hino_sp']['db_debug'] = (ENVIRONMENT !== 'production');
$db['db_hino_sp']['cache_on'] = FALSE;
$db['db_hino_sp']['cachedir'] = '';
$db['db_hino_sp']['char_set'] = 'utf8';
$db['db_hino_sp']['dbcollat'] = 'utf8_general_ci';
$db['db_hino_sp']['swap_pre'] = '';
$db['db_hino_sp']['autoinit'] = TRUE;
$db['db_hino_sp']['stricton'] = FALSE;


/* Database honda */
$db['kumalagroup']['hostname'] = '127.0.0.1';
$db['kumalagroup']['username'] = 'root';
$db['kumalagroup']['password'] = '168168168kmg';
$db['kumalagroup']['database'] = 'kumalagroup';
...
/* Database mazda */
$db['db_mazda']['hostname'] = '127.0.0.1';
$db['db_mazda']['username'] = 'root';
...
/* Database KUC */
$db['db_kuc']['hostname'] = '127.0.0.1';
$db['db_kuc']['username'] = 'root';
$db['db_kuc']['password'] = '168168168kmg';
$db['db_kuc']['database'] = 'db_kuc';
$db['db_kuc']['dbdriver'] = 'mysqli';
$db['db_kuc']['dbprefix'] = '';
$db['db_kuc']['pconnect'] = FALSE;
$db['db_kuc']['db_debug'] = (ENVIRONMENT !== 'production');
$db['db_kuc']['cache_on'] = FALSE;
$db['db_kuc']['cachedir'] = '';
$db['db_kuc']['char_set'] = 'utf8';
$db['db_kuc']['dbcollat'] = 'utf8_general_ci';
$db['db_kuc']['swap_pre'] = '';
$db['db_kuc']['autoinit'] = TRUE;
$db['db_kuc']['stricton'] = FALSE;
